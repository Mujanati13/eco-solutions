    ...
    try {
      ...
      await pool.query(`
        CREATE TABLE IF NOT EXISTS orders (
          ...
          status ENUM('pending', 'confirmed', 'out_for_delivery', 'delivered', 'cancelled', 'returned') DEFAULT 'pending',
  ...
  static async updateOrdersSchema() {
    try {
      ...
      await pool.query(`
        ...
        ENUM('pending', 'confirmed', 'processing', 'out_for_delivery', 'delivered', 'cancelled', 'returned', 'on_hold') 
        DEFAULT 'pending'
      `);
